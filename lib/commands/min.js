...
(function() {
  var cc, computecluster, max, save_versions_json, save_versions_mapping, syspath, utils;
  ...
  save_versions_json = function(json_file_path, mapping) {
    var json, k, v;
    json = {};
    for (k in mapping) {
      v = mapping[k];
    ...
    return utils.file.io.write(json_file_path, JSON.stringify(json));
  };
